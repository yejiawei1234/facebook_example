...
if __name__ == '__main__':
    ...
    fields = ['account_id', 'account_name', 'impressions', 'clicks', 'spend', 'ctr', 'actions']
    ...
    for accounts in generate_batches(my_accounts_list, 25):
        ...
        for account in accounts:
            account_insight = account.get_insights(fields=fields, params=params, batch=api_batch)
